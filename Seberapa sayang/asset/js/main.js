    ...
    Swal.fire({
        ...
        Swal.fire({
            ...
            Swal.fire({
                ...
                text: 'nanti di record ya!, abis itu dikirim sekali liat aja!!',
                showClass: {
                    popup: 'animate__animated animate__jackInTheBox'
                },
                hideClass: {
                ...
                Swal.fire({
                    ...
                    function () {
                        ...
                        console.log(nama);
                        Swal.fire({
                            title: nama + ' ' + 'kangen gak sama aku?',
                            icon: 'question',
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    title: 'aku juga kangen banget sama ' + nama,
                                    showClass: {
                                        popup: 'animate__animated animate__jackInTheBox'
                                    },
                                    hideClass: {
                                    ...
                                    Swal.queue([{
                                        title: 'seberapa kangen' + ' ' + nama + ' ' + 'ke aku?',
                                        confirmButtonText: 'Submit',
                                        showCancelButton: true,
                                        text: 'coba isi pengen tau seberapa kangen kamu ke aku',
                                        showClass: {
                                            popup: 'animate__animated animate__jackInTheBox'
                                        },
                                        hideClass: {
                                        ...
                                        preConfirm: function (value) {
                                            Swal.insertQueueStep({
                                                title: 'makasih sudah kangen ke aku' + ' ' + value + '%',
                                                icon: "info",
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
